...
# ===============================================
pygame.init()
# pygame.mixer.init()  # Descomente quando for usar som
...
vel_x, vel_y = centralizar_bola()  # Define velocidade inicial da bola
...
while rodando:
    ...
    if bola.colliderect(paddle_esq) or bola.colliderect(paddle_dir):
        vel_x = -vel_x
        # Som de quique aqui também (descomente quando tiver o arquivo)
        # pygame.mixer.Sound("assets/bounce.wav").play()
    ...
    if bola.left <= 0:
        ...
        # Som de ponto (descomente quando tiver o arquivo)
        # pygame.mixer.Sound("assets/point.wav").play()
